                    ...
                    <div style={{display:"flex", flexShrink:0}}>
                        <div style={{display:"flex", flexDirection:"column", boxSizing:"border-box", width:"50%"}}>
                            ...
                            <div style={{display:"flex", justifyContent:"center", width:"420px", margin:"20px auto 20px 0"}}>
                                <button 
                                    style={{width:"95%", height:"60px", borderRadius:"10px", border:"2px solid white",
                        ...
                        <div style={{display:"flex", boxSizing:"border-box", width:"50%", flexDirection:"column"}}>
                            ...
                            <div style={{textAlign:"start", display:"flex", flexDirection:"column", height:"300px"}}>
                                ...
                                <div style={{display:"flex", height:"100%"}}>
                                    <textarea 
                                        style={{resize:"none", overflow:"hidden", flexGrow:"1", backgroundColor:"transparent", padding:"5px 10px 5px 10px",
                                    ...
                                    <button style={{border:"none", backgroundColor:"white", borderRadius:"0 10px 10px 0"}}><img src="/images/music/paste_icon.png" alt="복사 버튼"/></button>
                                </div>
                            </div>
                        </div>
                    </div>
