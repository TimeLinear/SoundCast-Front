...
import ModifyMyPageModal from "./ModifyMyPageModal";
        ...
        <>
            ...
            <div className="UserIntroduce" style={{ width: "630px", height: "200px", marginLeft: "250px", marginTop: "80px" }}>
                ...
                <div style={{ display: "flex" }}>
                    <p style={{ margin: "0 10px 0 0", fontWeight: "bold" }}>팔로워</p><p style={{ margin: 0 }}>0{user.follow}</p>
                    <p style={{ margin: "0 10px 0 20px", fontWeight: "bold",cursor:"pointer" }} onClick={followingHandler} >팔로잉</p><p style={{ margin: 0 }}>10{user.follow}</p>
                </div>
